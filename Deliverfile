...
app_identifier "io.kilian.ParkenDD" # The bundle identifier of your app
apple_id "957165041" # This is NOT your Apple login ID, but the App ID of your app
email "me@kilian.io" # the login email address